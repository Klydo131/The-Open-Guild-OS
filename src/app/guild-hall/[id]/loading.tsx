    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="rounded-xl border border-tavern-border-glow bg-gradient-to-b from-tavern-surface-alt to-tavern-surface p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          <div className="w-16 h-16 rounded-lg bg-tavern-surface-alt animate-pulse shrink-0" />
          <div className="flex-1 space-y-3 w-full">
            <div className="h-7 w-52 bg-tavern-surface-alt rounded animate-pulse" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {Array.from({ length: 4 }, (_, i) => (
          <div key={i} className="rounded-xl border border-tavern-border bg-tavern-surface p-4 text-center">
            ...
            <div className="h-3 w-14 bg-tavern-surface-alt rounded animate-pulse mx-auto" />
          </div>
        ))}
      </div>
    </div>
